...
Runs in **dry-run mode by default** — shows the full archive plan before doing anything. Execution requires explicit confirmation. ArchKit never deletes files — archived files live in `.archkit/archive/` and can be restored at any time.
